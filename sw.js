// ═══════════════════════════════════════════════════════════════
// J.A.R.V.I.S. Service Worker v9 — RESPONSIVE (Phase F cache bump)
//
// Cache version bump per the standing rule logged in Phase E.1: any
// phase that changes index.html bumps CACHE so the activate handler
// purges old shells. Phase F changes the JS substantially (recurring
// tasks, voice expansion, chat-tab fix), so we cycle to v9.
//
// Responsibilities:
