// ═══════════════════════════════════════════════════════════════
// J.A.R.V.I.S. Service Worker v14 — RESPONSIVE (Phase F.4)
//
// Phase F.4: smaller ripples (180px hit / 245px miss) and the magenta
// diagnostic bar removed — the keyboard bug from F.3 is confirmed fixed.
// F.4 is the clean ship of Phase F.
// ═══════════════════════════════════════════════════════════════
