// ═══════════════════════════════════════════════════════════════
// J.A.R.V.I.S. Service Worker v10 — RESPONSIVE (Phase F.1 cache bump)
//
// Phase F.1 fix-pack for the residual chat-tab dark-bar bug. Cache
// bumped per the standing rule: any phase that changes index.html
// bumps CACHE so the activate handler purges old shells.
//
// Responsibilities:
