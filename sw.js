// ═══════════════════════════════════════════════════════════════
// J.A.R.V.I.S. Service Worker v20 — GAPFILL (Phase G.0)
//
// Phase G.0: cache bump only. Forces clients to pick up the new
// index.html which adds task-reminder L1 scheduling and removes
// the 30-day event horizon cap. No SW logic change.
//
// Phase F.9 (carry-over): precaches CDN scripts (React, ReactDOM,
// Babel, DOMPurify) so cold launches after the first one don't
// re-fetch ~250KB+ from the network. Per-URL .add() (not .addAll())
// so a single CDN failure doesn't break the install of the
// same-origin shell.
//
